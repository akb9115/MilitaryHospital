...
class searchcompletedata:
    def deleteaction(self):
        ...
        deletedata.deletedataaction(self,received_number,received_name,received_date)
        self.root.destroy()

    def exit(self):
        self.root.destroy()

    def viewdata(number,name,date):
        global received_number
        global received_name
        global received_date
    ...
    def __init__(self):
        ...
        self.bt_delete=Button(self.f, text="Delete Record", font=("times new roman", 11, "bold"), fg="white", bg="red",activebackground="snow", activeforeground="brown", height=1, width=20, command=self.deleteaction)
        ...
        self.bt_delete.grid(row=13,column=1,sticky=(W))
